  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center flex items-center justify-center">
            <RiTeamLine className="text-blue-500 mr-3" />
            Business Services
          </h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Printer network setup</h3>
            </div>
            
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
              <div className="flex items-center justify-center h-12 w-12 rounded-full bg-blue-100 mx-auto mb-4">
                <RiPrinterCloudLine className="text-blue-600 text-xl" />
              </div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Cloud print integration</h3>
            </div>
            
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
              <div className="flex items-center justify-center h-12 w-12 rounded-full bg-blue-100 mx-auto mb-4">
                <MdOutlinePrint className="text-blue-600 text-xl" />
              </div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Multiple printer management</h3>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Preventive maintenance</h3>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Remote & onsite support</h3>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Secure printing</h3>
            </div>
            
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
              <div className="flex items-center justify-center h-12 w-12 rounded-full bg-blue-100 mx-auto mb-4">
                <HiOutlineLightningBolt className="text-blue-600 text-xl" />
              </div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Fast SLA response</h3>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Monthly service contracts</h3>
            </div>
          </div>
        </div>
