                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center">
                          ...
                          <span>Toll-Free Support: (808) 468-1018</span>
                        </div>
                        <div className="flex items-center">
...
const termsAndConditionsContent = [
  {
    ...
    content: [
      ...
      'By using our website or contacting our toll-free support line (808) 468-1018, you agree to these Terms. If you do not agree, please discontinue use immediately.'
    ],
    subSections: [
      {
  ...
  },
  {
    ...
    content: [
      'By accessing the website, live chat, email, remote session, or our toll-free number (808) 468-1018, you confirm that:'
    ],
    subSections: [
      {
    ...
    subSections: [
      {
        ...
        content: [
          '📞 Toll-Free Support: (808) 468-1018',
